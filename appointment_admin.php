...
<body>
    ...
    <section id="Appointment">
        <div class="labas">
            <div class="filter">
                <div class="inn">
                    <p class="backbtn"><a href="searchappoint_admin.php"><i class="fa-solid fa-filter"></i>  Filter</a></p>
                </div>
            </div>
            <div class="print">
                <div class="pr">
                    <p class="printbtn"><a href="printappoint.php">Print  <i class="fa-solid fa-print"></i></a></p>
                </div>
            </div>
        </div>
        <div class="table">
