...
CREATE TABLE `admin` (
  ...
  `level` int(11) NOT NULL DEFAULT 0 COMMENT '1-for admin, 0-for others',
  `cgm_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `admin` (`id`, `username`, `password`, `level`, `cgm_id`) VALUES
(1, 'admin', 'admin', 1, 0),
(2, 'balete', 'admin', 0, 3),
(3, 'ggrumo', 'qwewqe', 0, 11);
...
INSERT INTO `appointment` (`id`, `date`, `fullname`, `email`, `contact`, `time`, `address`, `service`, `cgmchapter`, `cgm_id`, `message`, `room_id`, `status`) VALUES
(43, '2023-01-12', 'grace', 'grace.grumo12@gmail.com', '09551405749', '9:00 AM - 10:00 AM', 'address', 'Child dedication', 'CGM Balete, Batangas', 1, 'try', 0, 'Pending'),
(47, '2023-01-11', 'grace', 'grace.grumo12@gmail.com', '9551405749', '11:00 AM - 12:00 PM', 'ROSAL STREET', 'House blessing', 'CGM Balete, Batangas', 3, '', 0, 'Confirmed'),
(48, '2023-01-11', 'grace', 'grace.grumo12@gmail.com', '9551405749', '9:00 AM - 10:00 AM', 'ROSAL STREET', 'wedding', 'CGM Balete, Batangas', 3, 'qw', 0, 'Confirmed'),
(49, '2023-01-11', 'grace', 'grace.grumo12@gmail.com', '9551405749', '1:00 PM - 2:00 PM', 'ROSAL STREET', 'wedding', 'CGM Balete, Batangas', 3, 'qw', 0, 'Confirmed'),
(50, '2023-01-11', 'grace', 'grace.grumo@kmcmaggroup.com', '9178088425', '2:00 PM - 3:00 PM', 'address', 'Water baptism', 'CGM Balete, Batangas', 3, 'qw', 0, 'Confirmed'),
(51, '2023-01-11', 'grace', 'grace.grumo12@gmail.com', '9551405749', '4:00 PM - 5:00 PM', 'ROSAL STREET', 'Child dedication', 'CGM Balete, Batangas', 1, 'qw', 0, 'Confirmed');
...
INSERT INTO `attendance` (`id`, `cgmchapter`, `cgm_id`, `date`, `fullname`, `gender`, `contactnumber`, `age`, `address`) VALUES
(22, 'CGM Mabini, Tanauan', 0, '2022/11/23', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', '012 Mabini Tanauan City, Batangas'),
(23, 'CGM Mabini, Tanauan', 0, '2022/11/23', 'Vergel Bryan Tolentino', 'Male', '09516438165', '22', 'sto tomas City, Batangas'),
(24, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(25, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(26, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(27, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(28, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(31, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(32, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(33, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(34, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(35, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(36, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(37, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(38, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(39, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(40, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(41, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(42, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(43, 'CGM Mabini, Tanauan', 0, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(44, 'CGM Mabini, Tanauan', 10, '2022/11/30', 'John Kenneth M. Lopez', 'Male', '09771183520', '22', 'Brgy. Mabini Tanauan City, Batangas'),
(45, 'CGM Balete, Batangas', 3, '2023/01/12', 'grace', 'Male', '9178088425', '23', 'address');
...
(18, 'YOUTH ANNUAL ONLINE', 'upload/online.jpg', 'I am the vine; you are the branches. If you remain in me and I in you, you will bear much fruit; apart from me you can do nothing.', '2021-10-28', '08:00', 'CGM Las Pinas Main');
...
INSERT INTO `prayer` (`id`, `name`, `email`, `request`, `cgmchapter`, `cgm_id`, `report`, `status`, `date`) VALUES
(27, 'grace', 'grace.grumo12@gmail.com', 'w', 'CGM Cabuyao, Laguna', 3, 'w', 'Pending', '2023-01-12');
...
INSERT INTO `upcoming` (`id`, `title`, `image`, `des`, `date`, `time`, `loc`, `cgm_id`, `curdate`) VALUES
(20, 'Isang Tinig', ' upload/tinig.jpg', ' God said to Moses, “I am who I am.[a] This is what you are to say to the Israelites: ‘I am has sent me to you.’”', '2023-10-29', '08:00', 'CGM Las pinas main', 0, '2023-01-04'),
(21, 'Isang tinig', ' upload/tinig.jpg', 'qw', '2023-01-15', '10:50', 'main', 3, '2023-01-12');
